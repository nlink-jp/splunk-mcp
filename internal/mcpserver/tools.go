...
import (
	...
	"github.com/nlink-jp/splunk-mcp/internal/jsonrpc"
...
// to return multiple content blocks or non-JSON text — e.g. get_usage returns
// markdown as a plain text block.
...
func (s *Server) handleToolsCall(ctx context.Context, req jsonrpc.Request) error {
	...
	// Rich-content path: handler returned a RawResult, take its
