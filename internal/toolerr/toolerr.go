...
type Error struct {
	// Code is a stable slug for client-side branching (e.g. "unsafe_spl").
	Code string `json:"code"`
	// Message is a human-readable summary.
	Message string `json:"message"`
	// Details carries machine-readable context (e.g. SID, blocked command).
...
// values like New(CodeUnsafeSPL, "") work under errors.Is regardless of the
// inner Message and Details.
